...
public class ActGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ModelElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cAtelierAtelierRefParserRuleCall_1_0 = (RuleCall)cAtelierAssignment_1.eContents().get(0);
		
		//Model:
		//	{Model} atelier+=AtelierRef*;
		...
		//AtelierRef
		public RuleCall getAtelierAtelierRefParserRuleCall_1_0() { return cAtelierAtelierRefParserRuleCall_1_0; }
	}

	public class AtelierRefElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "AtelierRef");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cAtelierRefAction_0 = (Action)cGroup.eContents().get(0);
		...
		//AtelierRef:
		//	{AtelierRef} "atelier" id=EString "{" activity+=PeriodicActivity* "}";
		public ParserRule getRule() { return rule; }
		...
		//{AtelierRef}
		public Action getAtelierRefAction_0() { return cAtelierRefAction_0; }
	...
	public class ResAllocationElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cRessourceTypeResourceTypeEnumRuleCall_2_0 = (RuleCall)cRessourceTypeAssignment_2.eContents().get(0);
		...
		//	{RessourceAllocation} "reserve" ressourceType=ResourceType "for" duration=EInt periodicityType=Periodicity;
		public ParserRule getRule() { return rule; }
		...
		//ResourceType
		public RuleCall getRessourceTypeResourceTypeEnumRuleCall_2_0() { return cRessourceTypeResourceTypeEnumRuleCall_2_0; }
	...
	public class ResourceTypeElements extends AbstractEnumRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final EnumLiteralDeclaration cTractorEnumLiteralDeclaration_0 = (EnumLiteralDeclaration)cAlternatives.eContents().get(0);
		private final Keyword cTractorTractorKeyword_0_0 = (Keyword)cTractorEnumLiteralDeclaration_0.eContents().get(0);
		private final EnumLiteralDeclaration cWorkerEnumLiteralDeclaration_1 = (EnumLiteralDeclaration)cAlternatives.eContents().get(1);
		private final Keyword cWorkerWorkerKeyword_1_0 = (Keyword)cWorkerEnumLiteralDeclaration_1.eContents().get(0);
		...
		//Tractor
		public EnumLiteralDeclaration getTractorEnumLiteralDeclaration_0() { return cTractorEnumLiteralDeclaration_0; }

		//"Tractor"
		public Keyword getTractorTractorKeyword_0_0() { return cTractorTractorKeyword_0_0; }

		//Worker
		public EnumLiteralDeclaration getWorkerEnumLiteralDeclaration_1() { return cWorkerEnumLiteralDeclaration_1; }

		//"Worker"
		public Keyword getWorkerWorkerKeyword_1_0() { return cWorkerWorkerKeyword_1_0; }
	}
	
	private ModelElements pModel;
	private AtelierRefElements pAtelierRef;
	...
	//AtelierRef:
	//	{AtelierRef} "atelier" id=EString "{" activity+=PeriodicActivity* "}";
	public AtelierRefElements getAtelierRefAccess() {
		return (pAtelierRef != null) ? pAtelierRef : (pAtelierRef = new AtelierRefElements());
	}
	
	public ParserRule getAtelierRefRule() {
		return getAtelierRefAccess().getRule();
	}
