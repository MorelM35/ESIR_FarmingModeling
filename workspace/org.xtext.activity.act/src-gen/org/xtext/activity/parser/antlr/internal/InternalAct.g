...
entryRuleAtelierRef returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getAtelierRefRule()); }
	 iv_ruleAtelierRef=ruleAtelierRef 
	 { $current=$iv_ruleAtelierRef.current; } 
	 EOF 
;

// Rule AtelierRef
ruleAtelierRef returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
