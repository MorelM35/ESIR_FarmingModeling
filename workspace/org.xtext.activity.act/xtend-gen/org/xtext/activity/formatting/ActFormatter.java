 ...
 * generated by Xtext
 */
package org.xtext.activity.formatting;
...
public class ActFormatter extends AbstractDeclarativeFormatter {
  @Inject
  @Extension
  private ActGrammarAccess _actGrammarAccess;
  
  protected void configureFormatting(final FormattingConfig c) {
    List<Pair<Keyword, Keyword>> _findKeywordPairs = this._actGrammarAccess.findKeywordPairs("{", "}");
    ...
    List<Keyword> _findKeywords = this._actGrammarAccess.findKeywords(",");
    ...
    TerminalRule _sL_COMMENTRule = this._actGrammarAccess.getSL_COMMENTRule();
    _setLinewrap.before(_sL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_1 = c.setLinewrap(0, 1, 2);
    TerminalRule _mL_COMMENTRule = this._actGrammarAccess.getML_COMMENTRule();
    _setLinewrap_1.before(_mL_COMMENTRule);
    FormattingConfig.LinewrapLocator _setLinewrap_2 = c.setLinewrap(0, 1, 1);
    TerminalRule _mL_COMMENTRule_1 = this._actGrammarAccess.getML_COMMENTRule();
