		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEnumTypeRessourceAccess().getAlternatives(), "rule__EnumTypeRessource__Alternatives");
					put(grammarAccess.getModelAccess().getGroup(), "rule__Model__Group__0");
					put(grammarAccess.getAtelierAccess().getGroup(), "rule__Atelier__Group__0");
					...
					put(grammarAccess.getAtelierAccess().getIdAssignment_2(), "rule__Atelier__IdAssignment_2");
					put(grammarAccess.getAtelierAccess().getActivityAssignment_4(), "rule__Atelier__ActivityAssignment_4");
