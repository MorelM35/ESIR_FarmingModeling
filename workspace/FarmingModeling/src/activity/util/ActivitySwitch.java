...
public class ActivitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ActivityPackage.ACTIVITY_PERIODIC: {
				ActivityPeriodic activityPeriodic = (ActivityPeriodic)theEObject;
				T result = caseActivityPeriodic(activityPeriodic);
	 ...
	 * @generated
	 */
	public T caseActivityPeriodic(ActivityPeriodic object) {
		return null;
	}
