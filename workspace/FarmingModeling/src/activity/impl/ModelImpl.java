 ...
 *   <li>{@link activity.impl.ModelImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model {
	 ...
	 * @ordered
	 */
	protected EList<PeriodicActivity> activity;
	 ...
	 * @generated
	 */
	public EList<PeriodicActivity> getActivity() {
		if (activity == null) {
			activity = new EObjectContainmentEList<PeriodicActivity>(PeriodicActivity.class, this, ActivityPackage.MODEL__ACTIVITY);
		}
		return activity;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ActivityPackage.MODEL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ActivityPackage.MODEL__NAME:
				return getName();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case ActivityPackage.MODEL__ACTIVITY:
				getActivity().clear();
				getActivity().addAll((Collection<? extends PeriodicActivity>)newValue);
				return;
			case ActivityPackage.MODEL__RESSOURCE_TYPE:
